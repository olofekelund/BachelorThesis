...
/**
 * This is the item provider adapter for a {@link org.language.reqLanguage.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReqLanguagePackage.Literals.VALUE__VAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReqLanguagePackage.Literals.VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Value)object).getVal();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Value.class)) {
			case ReqLanguagePackage.VALUE__VAL:
			case ReqLanguagePackage.VALUE__VALUE:
