...
/**
 * This is the item provider adapter for a {@link org.language.reqLanguage.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_attribute_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_attribute_feature", "_UI_Attribute_type"),
				 ReqLanguagePackage.Literals.ATTRIBUTE__ATTRIBUTE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReqLanguagePackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Attribute.class)) {
			case ReqLanguagePackage.ATTRIBUTE__ATTRIBUTE:
			case ReqLanguagePackage.ATTRIBUTE__NAME:
