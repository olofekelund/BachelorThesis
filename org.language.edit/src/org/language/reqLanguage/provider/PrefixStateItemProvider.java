...
/**
 * This is the item provider adapter for a {@link org.language.reqLanguage.PrefixState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrefixStateItemProvider 
	 ...
	 * @generated
	 */
	public PrefixStateItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrefixState_prefixFixedSyntax_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrefixState_prefixFixedSyntax_feature", "_UI_PrefixState_type"),
				 ReqLanguagePackage.Literals.PREFIX_STATE__PREFIX_FIXED_SYNTAX,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReqLanguagePackage.Literals.PREFIX_STATE__STATE_EXPRESSION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PrefixState"));
	}
	...
	public String getText(Object object) {
		String label = ((PrefixState)object).getPrefixFixedSyntax();
		return label == null || label.length() == 0 ?
			getString("_UI_PrefixState_type") :
			getString("_UI_PrefixState_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrefixState.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReqLanguagePackage.Literals.PREFIX_STATE__STATE_EXPRESSION,
