...
/**
 * This is the item provider adapter for a {@link org.language.reqLanguage.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReqLanguagePackage.Literals.ACTION__ACTION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReqLanguagePackage.Literals.ACTION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ReqLanguagePackage.Literals.ACTION__PARAMETER);
			childrenFeatures.add(ReqLanguagePackage.Literals.ACTION__VALUE);
			childrenFeatures.add(ReqLanguagePackage.Literals.ACTION__SUBJECT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ReqLanguagePackage.Literals.ACTION__PARAMETER,
				 ReqLanguageFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(ReqLanguagePackage.Literals.ACTION__VALUE,
				 ReqLanguageFactory.eINSTANCE.createValue()));

		newChildDescriptors.add
			(createChildParameter
				(ReqLanguagePackage.Literals.ACTION__SUBJECT,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ReqLanguagePackage.Literals.ACTION__PARAMETER ||
			childFeature == ReqLanguagePackage.Literals.ACTION__SUBJECT ||
			childFeature == ReqLanguagePackage.Literals.ACTION__VALUE;
